export const MoonIcon = () => {
  return (
    <div>
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="dark:stroke-[#4B5563]" xmlns="http://www.w3.org/2000/svg">
...
<path d="M19 3V7" stroke="#D1D5DB" className="dark:stroke-[#4B5563]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M21 5H17" stroke="#D1D5DB" className="dark:stroke-[#4B5563]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
